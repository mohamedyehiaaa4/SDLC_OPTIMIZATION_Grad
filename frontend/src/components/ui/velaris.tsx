...
// RepoMind brand palette: a liquid navy/blue marble swirl (deep indigo ->
// vivid blue -> near-black), matching the reference login-card art direction.
const DEFAULT_COLORS = ["#1a2f8f", "#3358f4", "#0a0e2e", "#05060a"];
